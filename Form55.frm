...
Begin VB.Form Form55 
   Caption         =   "Result's of Test(Science)"
   ClientHeight    =   8220
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   11835
...
id = Combo1.Text
With rs2
.Open "select * from ResultofTestScience where ResultofTestScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofTestScience.StudentID from ResultofTestScience where ResultofTestScience.Class = 'Test(Science)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
