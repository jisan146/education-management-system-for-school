...
id = Combo1.Text
With rs2
.Open "select * from ResultofOne where ResultofOne.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofOne.StudentID from ResultofOne where ResultofOne.Class = 'one'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
