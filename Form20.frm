...
Begin VB.Form Form20 
   Caption         =   "Due Payment Infomation of Class Baby "
   ClientHeight    =   8895
   ClientLeft      =   1980
   ClientTop       =   495
   ClientWidth     =   11385
...
id = Combo1.Text
With rs2
.Open "select * from PaymentBaby where PaymentBaby.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentBaby.StudentID from PaymentBaby where PaymentBaby.Class = 'Baby'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
