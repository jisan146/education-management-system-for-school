...
Begin VB.Form Form12 
   Caption         =   "Student Information(Seven)"
   ClientHeight    =   8220
   ClientLeft      =   2670
   ClientTop       =   1155
   ClientWidth     =   11040
...
With rs2
.Open "select * from Seven Where Seven.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Seven.StudentID from Seven", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
