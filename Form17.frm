...
Begin VB.Form Form17 
   Caption         =   "Student Information (Ten Science)"
   ClientHeight    =   8010
   ClientLeft      =   1020
   ClientTop       =   495
   ClientWidth     =   11040
...
With rs2
.Open "select * from TenScience Where TenScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select TenScience.StudentID from TenScience", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
