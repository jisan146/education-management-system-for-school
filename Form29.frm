...
Begin VB.Form Form29 
   Caption         =   "Due Payment Infomation of ClassNine (Science)"
   ClientHeight    =   9195
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11310
...
id = Combo1.Text
With rs2
.Open "select * from PaymentNineScience where PaymentNineScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentNineScience.StudentID from PaymentNineScience where PaymentNineScience.Class = 'Nine(Science)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
