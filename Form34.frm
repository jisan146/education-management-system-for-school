...
Begin VB.Form Form34 
   Caption         =   "Due Payment Infomation of Class Ten (Human)"
   ClientHeight    =   9195
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11310
...
id = Combo1.Text
With rs2
.Open "select * from PaymentTenHuman where PaymentTenHuman.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentTenHuman.StudentID from PaymentTenHuman where PaymentTenHuman.Class = 'Ten(Human)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
