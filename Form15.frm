...
Begin VB.Form Form15 
   Caption         =   "Student Information (Nine Business)"
   ClientHeight    =   7680
   ClientLeft      =   1020
   ClientTop       =   495
   ClientWidth     =   11070
...
With rs2
.Open "select * from NineBusiness Where NineBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select NineBusiness.StudentID from NineBusiness", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
