...
Begin VB.Form Form24 
   Caption         =   "Due Payment Infomation of Class Four"
   ClientHeight    =   9165
   ClientLeft      =   1320
   ClientTop       =   495
   ClientWidth     =   11400
...
id = Combo1.Text
With rs2
.Open "select * from PaymentFour where PaymentFour.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentFour.StudentID from PaymentFour where PaymentFour.Class = 'Four'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
