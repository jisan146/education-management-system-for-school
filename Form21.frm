...
Begin VB.Form Form21 
   Caption         =   "Due Payment Infomation of Class One"
   ClientHeight    =   8850
   ClientLeft      =   1140
   ClientTop       =   495
   ClientWidth     =   11325
...
id = Combo1.Text
With rs2
.Open "select * from PaymentOne where PaymentOne.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentOne.StudentID from PaymentOne where PaymentOne.Class = 'One'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
