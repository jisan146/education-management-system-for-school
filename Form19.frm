...
Begin VB.Form Form19 
   Caption         =   "Student Information (Ten Human)"
   ClientHeight    =   7995
   ClientLeft      =   1080
   ClientTop       =   495
   ClientWidth     =   11115
...
With rs2
.Open "select * from TenHuman Where TenHuman.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select TenHuman.StudentID from TenHuman", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
