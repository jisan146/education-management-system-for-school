VERSION 5.00
Begin VB.Form Form5 
   Caption         =   "Student Information(Baby)"
   ClientHeight    =   6435
   ClientLeft      =   3780
   ClientTop       =   495
   ClientWidth     =   8805
...
With rs2
.Open "select * from Baby Where Baby.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Baby.StudentID from Baby", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
