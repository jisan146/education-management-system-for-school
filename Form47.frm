...
Begin VB.Form Form47 
   Caption         =   "Result's of Nine(Business)"
   ClientHeight    =   8100
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   11550
...
id = Combo1.Text
With rs2
.Open "select * from ResultofNineBusiness where ResultofNineBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofNineBusiness.StudentID from ResultofNineBusiness where ResultofNineBusiness.Class = 'Nine(Business)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
