...
Begin VB.Form Form31 
   Caption         =   "Due Payment Infomation of Class Nine (Human)"
   ClientHeight    =   9150
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11265
...
id = Combo1.Text
With rs2
.Open "select * from PaymentNineHuman where PaymentNineHuman.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentNineHuman.StudentID from PaymentNineHuman where PaymentNineHuman.Class = 'Nine(Human)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
