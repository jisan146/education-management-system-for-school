...
id = Combo1.Text
With rs2
.Open "select * from ResultofFive where ResultofFive.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofFive.StudentID from ResultofFive where ResultofFive.Class = 'Five'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
