...
Begin VB.Form Form27 
   Caption         =   "Due Payment Infomation of Class Seven"
   ClientHeight    =   9090
   ClientLeft      =   1140
   ClientTop       =   495
   ClientWidth     =   11415
...
id = Combo1.Text
With rs2
.Open "select * from PaymentSeven where PaymentSeven.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentSeven.StudentID from PaymentSeven where PaymentSeven.Class = 'Seven'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
