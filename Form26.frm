...
Begin VB.Form Form26 
   Caption         =   "Due Payment Infomation of Class Six"
   ClientHeight    =   9165
   ClientLeft      =   1260
   ClientTop       =   495
   ClientWidth     =   11400
...
id = Combo1.Text
With rs2
.Open "select * from PaymentSix where PaymentSix.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentSix.StudentID from PaymentSix where PaymentSix.Class = 'Six'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
