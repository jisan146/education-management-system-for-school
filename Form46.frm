...
Begin VB.Form Form46 
   Caption         =   "Result's of Nine(Science)"
   ClientHeight    =   8925
   ClientLeft      =   1005
   ClientTop       =   495
   ClientWidth     =   11520
...
id = Combo1.Text
With rs2
.Open "select * from ResultofNineScience where ResultofNineScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofNineScience.StudentID from ResultofNineScience where ResultofNineScience.Class = 'Nine(Science)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
