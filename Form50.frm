...
Begin VB.Form Form50 
   Caption         =   "Result's of Ten(Business)"
   ClientHeight    =   8385
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   11355
...
id = Combo1.Text
With rs2
.Open "select * from ResultofTenBusiness where ResultofTenBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofTenBusiness.StudentID from ResultofTenBusiness where ResultofTenBusiness.Class = 'Ten(Business)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
