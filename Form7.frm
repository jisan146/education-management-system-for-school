VERSION 5.00
Begin VB.Form Form7 
   Caption         =   "Student Information(Two)"
   ClientHeight    =   7590
   ClientLeft      =   1080
   ClientTop       =   495
   ClientWidth     =   11325
...
With rs2
.Open "select * from Two Where Two.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Two.StudentID from Two", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
