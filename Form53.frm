...
Begin VB.Form Form53 
   Caption         =   "Result's of Pree-Test(Business)"
   ClientHeight    =   8115
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   11385
...
id = Combo1.Text
With rs2
.Open "select * from ResultofPreeTestBusiness where ResultofPreeTestBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofPreeTestBusiness.StudentID from ResultofPreeTestBusiness where ResultofPreeTestBusiness.Class = 'PreeTest(Business)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
