...
Begin VB.Form Form10 
   Caption         =   "Student Information(Five)"
   ClientHeight    =   8160
   ClientLeft      =   1020
   ClientTop       =   495
   ClientWidth     =   10980
...
With rs2
.Open "select * from Five Where Five.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Five.StudentID from Five", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
