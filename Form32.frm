...
Begin VB.Form Form32 
   Caption         =   "Due Payment Infomation of Class Ten (Science)"
   ClientHeight    =   9090
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11280
...
id = Combo1.Text
With rs2
.Open "select * from PaymentTenScience where PaymentTenScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentTenScience.StudentID from PaymentTenScience where PaymentTenScience.Class = 'Ten(Science)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
