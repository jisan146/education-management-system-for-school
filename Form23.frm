...
Begin VB.Form Form23 
   Caption         =   "Due Payment Infomation of Class Three"
   ClientHeight    =   9165
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11340
...
id = Combo1.Text
With rs2
.Open "select * from PaymentThree where PaymentThree.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentThree.StudentID from PaymentThree where PaymentThree.Class = 'Three'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
