...
id = Combo1.Text
With rs2
.Open "select * from ResultofEight where ResultofEight.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofEight.StudentID from ResultofEight where ResultofEight.Class = 'Eight'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
