...
Begin VB.Form Form28 
   Caption         =   "Due Payment Infomation of Class Eight"
   ClientHeight    =   9135
   ClientLeft      =   1140
   ClientTop       =   495
   ClientWidth     =   11355
...
id = Combo1.Text
With rs2
.Open "select * from PaymentEight where PaymentEight.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentEight.StudentID from PaymentEight where PaymentEight.Class = 'Eight'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
