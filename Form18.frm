...
Begin VB.Form Form18 
   Caption         =   "Student Information (Ten Business)"
   ClientHeight    =   7965
   ClientLeft      =   1020
   ClientTop       =   495
   ClientWidth     =   11070
...
With rs2
.Open "select * from TenBusiness Where TenBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select TenBusiness.StudentID from TenBusiness", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
