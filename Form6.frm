VERSION 5.00
Begin VB.Form Form6 
   Caption         =   "Student Information(One)"
   ClientHeight    =   8010
   ClientLeft      =   1140
   ClientTop       =   495
   ClientWidth     =   11115
...
With rs2
.Open "select * from One Where One.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select One.StudentID from One", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
