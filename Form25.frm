...
Begin VB.Form Form25 
   Caption         =   "Due Payment Infomation of Class Five"
   ClientHeight    =   8865
   ClientLeft      =   1260
   ClientTop       =   495
   ClientWidth     =   11415
...
id = Combo1.Text
With rs2
.Open "select * from PaymentFive where PaymentFive.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentFive.StudentID from PaymentFive where PaymentFive.Class = 'Five'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
