VERSION 5.00
Begin VB.Form Form8 
   Caption         =   "Student Information(Three)"
   ClientHeight    =   7545
   ClientLeft      =   1080
   ClientTop       =   495
   ClientWidth     =   11325
...
With rs2
.Open "select * from Three Where Three.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Three.StudentID from Three", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
