...
id = Combo1.Text
With rs2
.Open "select * from ResultofSix where ResultofSix.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofSix.StudentID from ResultofSix where ResultofSix.Class = 'Six'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
