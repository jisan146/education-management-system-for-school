...
Begin VB.Form Form14 
   Caption         =   "Student Information (Nine Science)"
   ClientHeight    =   7845
   ClientLeft      =   1080
   ClientTop       =   495
   ClientWidth     =   11145
...
With rs2
.Open "select * from NineScience Where NineScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select NineScience.StudentID from NineScience", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
