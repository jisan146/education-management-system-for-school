...
Begin VB.Form Form22 
   Caption         =   "Due Payment Infomation of Class Two"
   ClientHeight    =   9030
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11310
...
id = Combo1.Text
With rs2
.Open "select * from PaymentTwo where PaymentTwo.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentTwo.StudentID from PaymentTwo where PaymentTwo.Class = 'Two'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
