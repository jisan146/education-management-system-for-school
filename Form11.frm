...
Begin VB.Form Form11 
   Caption         =   "Student Information(Six)"
   ClientHeight    =   7980
   ClientLeft      =   960
   ClientTop       =   495
   ClientWidth     =   11085
...
With rs2
.Open "select * from Six Where Six.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Six.StudentID from Six", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
