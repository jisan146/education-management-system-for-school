...
Begin VB.Form Form30 
   Caption         =   "Due Payment Infomation of Class Nine (Business)"
   ClientHeight    =   9165
   ClientLeft      =   1200
   ClientTop       =   495
   ClientWidth     =   11325
...
id = Combo1.Text
With rs2
.Open "select * from PaymentNineBusiness where PaymentNineBusiness.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select PaymentNineBusiness.StudentID from PaymentNineBusiness where PaymentNineBusiness.Class = 'Nine(Business)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
