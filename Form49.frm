...
Begin VB.Form Form49 
   Caption         =   "Result's of Ten(Science)"
   ClientHeight    =   8445
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   11955
...
id = Combo1.Text
With rs2
.Open "select * from ResultofTenScience where ResultofTenScience.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(4)
Text2.Text = .Fields(5)
...
End With
With rs
.Open "Select ResultofTenScience.StudentID from ResultofTenScience where ResultofTenScience.Class = 'Ten(Science)'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
