VERSION 5.00
Begin VB.Form Form9 
   Caption         =   "Student Information(Four)"
   ClientHeight    =   7530
   ClientLeft      =   1080
   ClientTop       =   495
   ClientWidth     =   11400
...
With rs2
.Open "select * from Four Where Four.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Four.StudentID from Four", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
