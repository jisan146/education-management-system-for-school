...
Begin VB.Form Form13 
   Caption         =   "Student Information(Eight)"
   ClientHeight    =   8070
   ClientLeft      =   1020
   ClientTop       =   495
   ClientWidth     =   11025
...
With rs2
.Open "select * from Eight Where Eight.StudentID='" & id & "'", cnn, adOpenKeyset, adLockOptimistic
End With
With rs2
Text1.Text = .Fields(1)
Text2.Text = .Fields(2)
...
End With
With rs
.Open "Select Eight.StudentID from Eight", cnn, adOpenKeyset, adLockOptimistic
End With
With rs
Dim str As String
